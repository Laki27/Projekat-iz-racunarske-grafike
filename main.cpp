...
int main() {
    ...
    Shader sunce("../resources/shader/vertex2.vs", "../resources/shader/svetslost.fs");
    Shader ulicno("../resources/shader/vertex2.vs", "../resources/shader/svetslost.fs");
    Shader podloga("../resources/shader/vertex3.vs", "../resources/shader/podloga.fs");
    Shader trava("../resources/shader/vertex4.vs", "../resources/shader/trava.fs");
    Shader skyboxShader("../resources/shader/vertex5.vs", "../resources/shader/skyBox.fs");
    ...
    while(!glfwWindowShouldClose(window)){
        ...
        model = glm::rotate(model, (float)(-pi/2.0f), glm::vec3(1.0f, 0.0f, 0.0f));
        ...
        for(unsigned int i=0; i<7; i++){
            ...
            model = glm::rotate(model, (float) (-3.14f / 2.0), glm::vec3(1.0f, 0.0f, 0.0f));
